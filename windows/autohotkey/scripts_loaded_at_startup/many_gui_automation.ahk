...
; wait for the program to become available with certain timeout
WinWait, Launcher ahk_exe launcher.exe,, 10
if ErrorLevel
{
...
; only accept if it shows up though
WinWait, WARNING! ahk_exe launcher.exe,, 3
if !ErrorLevel
{
