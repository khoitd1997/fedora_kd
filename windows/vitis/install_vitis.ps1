...
If (-Not $installed) {
    try {
        Write-Host "Extracting Vitis install files" -ForegroundColor black -BackgroundColor white
    ...
    Write-Host "Vitis hasn't been installed yet, installing" -ForegroundColor black -BackgroundColor white
