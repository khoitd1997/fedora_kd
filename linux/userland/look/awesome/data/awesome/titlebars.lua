...
client.connect_signal(
    ...
    function(c)
        ...
        if beautiful.titlebars_imitate_borders then
            helpers.create_titlebar(c, buttons, "top", 0)
            helpers.create_titlebar(c, buttons, "bottom", 0)
            helpers.create_titlebar(c, buttons, "left", 0)
            helpers.create_titlebar(c, buttons, "right", 0)
